"""
Fast CNN-LSTM Training with Mixed Precision (model 2)
Uses pre-encoded numpy arrays from `3. preprocess-data 2.py`.

Input  : data/processed/model_2/{train,val,test}_{X,y}.npy + metadata.json
Output : models/cnn_lstm_best_2.pt, models/results_2.json
"""
...
DATA_DIR = PROJECT_ROOT / "data" / "processed" / "model_2"
MODELS_DIR = PROJECT_ROOT / "models"
MODELS_DIR.mkdir(parents=True, exist_ok=True)

CKPT_PATH = MODELS_DIR / "cnn_lstm_best_2.pt"
RESULTS_PATH = MODELS_DIR / "results_2.json"
